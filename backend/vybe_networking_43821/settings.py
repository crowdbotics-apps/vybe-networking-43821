"""
Django settings for vybe_networking_43821 project.
...
ROOT_URLCONF = 'vybe_networking_43821.urls'
...
WSGI_APPLICATION = 'vybe_networking_43821.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vybe_networking_43821 API",
    "DESCRIPTION": "API documentation for vybe_networking_43821 App",
    "VERSION": "v1",
}
